...
// ΓöÇΓöÇΓöÇ Location content ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
const floridaContent: LocationContent = {
  ...
  heroH1: 'Tile Installer Jacksonville & St. Augustine, FL ΓÇö Expert Installation',
  heroTitle: 'Transform Your Space with Premium Tiles',
  heroSubtitle: 'Professional Installation ΓÇó Quality Materials ΓÇó Lifetime Warranty',
  heroDescription:
...
const stAugustineContent: LocationContent = {
  ...
  heroSubtitle: 'Serving the Ancient City Since 2008 ΓÇó Licensed & Insured',
  heroDescription:
...
const jacksonvilleContent: LocationContent = {
  ...
  heroSubtitle: 'Serving Jax & the Beaches Since 2008 ΓÇó Licensed & Insured',
  heroDescription:
...
// ΓöÇΓöÇΓöÇ Root Component ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ Hero Section ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
const HeroSection = ({ content }: { content: LocationContent }) => {
  ...
  const slides = [
    ...
    },
    {
      ...
      subtitle: 'Custom Designs ΓÇó Expert Craftsmanship ΓÇó Built for Florida Climate',
    ...
    },
    {
      ...
      subtitle: 'Stylish Designs ΓÇó Perfect Installation ΓÇó Lasting Beauty',
...
// ΓöÇΓöÇΓöÇ Projects Strip Section ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ

const PLACEHOLDER_PROJECTS: ProjectListItem[] = [
  { id: -1,  title: 'Kitchen Backsplash ΓÇö Jacksonville',   cover_image: '/images/backsplash/1.webp', cover_media_type: 'image', job_types: ['kitchen-backsplash'], is_featured: true },
  ...
  { id: -4,  title: 'Floor Tile ΓÇö Modern Living Room',     cover_image: '/images/flooring/2.webp',   cover_media_type: 'image', job_types: ['floor-tile'],         is_featured: false },
  ...
  { id: -6,  title: 'Bathroom Tile ΓÇö St. Augustine',       cover_image: '/images/shower/5.webp',     cover_media_type: 'image', job_types: ['bathroom-tile'],      is_featured: false },
...
// ΓöÇΓöÇΓöÇ Why Choose Us Section ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <p className="text-gray-600 text-lg leading-relaxed mb-8">
            Since 2008, Gazmend Tola and his team have been transforming Northeast Florida homes with meticulous tile work. We're not a franchise ΓÇö every job is handled by our own crew, with the same care we'd put into our own homes.
          </p>
...
// ΓöÇΓöÇΓöÇ Geo Splitter (Florida only) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ Cross-City (city pages) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ Local Services Section (city pages only) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ

const cityServiceCards = [
  {
    slug: 'kitchen-backsplash',
    label: 'Kitchen Backsplash Installation',
    description: 'Custom subway, mosaic, and large-format backsplashes ΓÇö precision-set with waterproof grout for lasting beauty.',
    icon: ChefHat,
  ...
  },
  {
    ...
    description: 'Full bathroom tile transformations ΓÇö walls, floors, and shower surrounds ΓÇö from elegant marble to modern porcelain.',
    icon: Bath,
  ...
  },
  {
    ...
    description: "Fully waterproofed shower systems using Schluter or mud-bed methods ΓÇö built for Florida's humid climate.",
    icon: Wrench,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-relaxed">
            We specialize in tile installation across {content.countyName} ΓÇö{' '}
            ...
            {' '}ΓÇö with free estimates and a 2-year workmanship warranty on every project.
          </p>
        </div>
...
// ΓöÇΓöÇΓöÇ Blog Carousel Section ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ

const PLACEHOLDER_POSTS: BlogPostListItem[] = [
  {
    id: -1, title: 'How to Choose the Right Tile for Your Kitchen Backsplash',
    slug: '#', excerpt: 'From subway tiles to mosaic glass, we break down the best backsplash options for Florida kitchens ΓÇö and what to avoid.',
  ...
  },
  {
    ...
    slug: '#', excerpt: 'Large-format tiles, bold patterns, and wet-room showers ΓÇö here are the looks our customers love most this year.',
  ...
  },
  {
    ...
    slug: '#', excerpt: 'The two most popular tile types explained ΓÇö density, water absorption, durability, and which one to pick for each room.',
...
// ΓöÇΓöÇΓöÇ Location Section (unchanged) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
      ...
      <div className="grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-xl p-6 shadow-md">
            <h3 className="text-xl font-semibold text-gray-900 mb-4">Tola Tiles ΓÇö {content.locationName}</h3>
...
// ΓöÇΓöÇΓöÇ Final CTA Section (unchanged) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
