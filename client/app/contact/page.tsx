...
export const metadata: Metadata = {
  ...
  description:
    'Contact Tola Tiles for expert tile installation services. Get a free quote, schedule consultation, or call (904) 866-1738. Licensed professionals serving your area.',
