...
export default function ContentListPage({ contentType }: ContentListPageProps) {
  ...
  }, [statusFilter, categoryFilter, contentType]);
      ...
      <div className="p-4 sm:p-6">
        ...
        <div className="flex flex-col gap-4 mb-4 sm:mb-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-gray-900">{label}</h1>
              <p className="text-sm text-gray-600 mt-1 hidden sm:block">Manage your {label.toLowerCase()} content and SEO</p>
            </div>
