...
interface ServiceDetailPageStAugustineProps {
  service: Service;
  relatedServices: Service[];
  serviceIdToSlug: Record<string, string>;
}

const ServiceDetailPageStAugustine = ({ service, relatedServices, serviceIdToSlug }: ServiceDetailPageStAugustineProps) => {
  ...
  const createQuoteEmailLink = () => {
    const subject = encodeURIComponent(`Quote Request - ${service.title} in St Augustine`);
    const body = encodeURIComponent(`
Hello Tola Tiles,

I would like to request a quote for ${service.title} in St Augustine.
    ...
    <div className="pt-20">
      ...
      <nav className="bg-gray-50 py-4" aria-label="Breadcrumb">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ol className="flex items-center space-x-2 text-sm">
            ...
            <li>
              <Link href="/st-augustine" className="text-gray-500 hover:text-blue-600">
                St Augustine
              </Link>
            </li>
            <li>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">{service.title} in St Augustine</h1>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {galleryImages.slice(0, 4).map((image, index) => (
                    <div key={image.id} className={`rounded-xl overflow-hidden shadow-lg ${index === 0 ? 'col-span-2' : ''}`}>
                      <Image
                        src={image.src}
                        alt={`${service.title} example in St Augustine - ${image.title}`}
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <header className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">See examples of our {service.title.toLowerCase()} work in St Augustine</p>
          </header>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <header className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Explore our other tile installation services in St Augustine</p>
          </header>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-blue-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">Get a free consultation and quote for your {service.title.toLowerCase()} project in St Augustine.</p>
...
export default ServiceDetailPageStAugustine;
