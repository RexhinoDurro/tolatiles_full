...
export const RELATED_SERVICE_PAGE_OPTIONS: RelatedServicePageGroup[] = [
  {
    ...
    options: [
      ...
      { value: '/jacksonville/services/kitchen-backsplash', label: 'Jacksonville — Kitchen Backsplash' },
      { value: '/jacksonville/services/bathroom-tile', label: 'Jacksonville — Bathroom Tile' },
      { value: '/jacksonville/services/floor-tile', label: 'Jacksonville — Floor Tile' },
      { value: '/jacksonville/services/patio-tile', label: 'Jacksonville — Patio Tile' },
      { value: '/jacksonville/services/fireplace-tile', label: 'Jacksonville — Fireplace Tile' },
      { value: '/jacksonville/services/shower-tile', label: 'Jacksonville — Shower Tile' },
    ],
  },
  {
    city: 'St. Augustine',
    options: [
      ...
      { value: '/st-augustine/services/kitchen-backsplash', label: 'St. Augustine — Kitchen Backsplash' },
      { value: '/st-augustine/services/bathroom-tile', label: 'St. Augustine — Bathroom Tile' },
      { value: '/st-augustine/services/floor-tile', label: 'St. Augustine — Floor Tile' },
      { value: '/st-augustine/services/patio-tile', label: 'St. Augustine — Patio Tile' },
      { value: '/st-augustine/services/fireplace-tile', label: 'St. Augustine — Fireplace Tile' },
      { value: '/st-augustine/services/shower-tile', label: 'St. Augustine — Shower Tile' },
    ],
  },
];
